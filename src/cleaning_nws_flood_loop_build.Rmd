...
I did a lot of work figuring out some of the issues with this!

The code chunk function below now has no rows with missing County Titles, so you should work on getting this code copied over to your full loop.
...
nws_files <- get_filepaths('data/storm_events/11-5', start_year = 2019, end_year = 2023)
...
test_df <-  read_csv(here("data/storm_events/11-5/StormEvents_details-ftp_v1.0_d2020_c20230927.csv/StormEvents_details-ftp_v1.0_d2020_c20230927.csv"))
...
test2_df <-  read_csv(here("data/storm_events/11-5/StormEvents_details-ftp_v1.0_d2020_c20230927.csv/StormEvents_details-ftp_v1.0_d2020_c20230927.csv"),
                      col_types = cols(
...
I am getting a lot of "null" values for location, in Tableau. I want to see if the same thing is happening here.
...
write_csv(flood_df, here("data/storm_events/test/cleaning_flood_dmg.csv"))
...
write_csv(geo_flood_df, here("data/storm_events/test/cleaning_geo_flood_dmg.csv"))
...
Are they coming from the main data, or the county names data I join for the geo?
