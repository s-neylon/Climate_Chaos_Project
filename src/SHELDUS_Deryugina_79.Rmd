...
Once I figure this out, this section and code will be removed!
...
#### 79! Any Hurricane damage

!!!!!!!!!1979 !!!! Has been removed!!!

```{r eval=TRUE}

HrSHLD_dery_df <- HrSHLD_dery_df %>%
  # Serious hurricane damage
  mutate(any_hurrDMG_SHLD = if_else(PropertyDmg_Adj2022 > 0 & year >= 1980 & year <= 2002, 1, 0))
...
saveRDS(HrSHLD_dery_df, here("data/SHELDUS/SHELDUS_Deryugina79.rds"))
...
# Full Data
write_csv(HrSHLD_dery_df, here("data/SHELDUS/SHELDUS_Deryugina79.csv"))
