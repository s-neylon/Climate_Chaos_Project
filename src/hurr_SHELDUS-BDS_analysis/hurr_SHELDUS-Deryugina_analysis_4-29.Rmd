...
I am trying this code out again, only using the 'hurr' variable, which is just any hurricane damage.
...
ln.emp.fect.1 <- fect(ln_emp ~ treatment_hurr, 
                data = hurr_df, 
                index = c("FIPS","year"),
...
plot(ln.emp.fect.1, main = "Estimated ATT (IFEct)")
...
plot(ln.emp.fect.1, xlim = c(-10, 10), main = "Estimated ATT (IFEct)")
...
plot(ln.emp.fect.1, type = "box", xlim = c(-10, 10), main = "ATT - HTE Box Plot")
...
plot(ln.emp.fect.1, type = "calendar")
