...
out0 <- gsynth(emp_rate_tot_adult ~ h_persist + pop_pm + log_pop + log_wage_pc + frac_young + frac_old + frac_black, 
...
out1 <- gsynth(emp_rate_tot_adult ~ h_persist + pop_pm + log_pop + log_wage_pc + frac_young + frac_old + frac_black, 
               data = subset_df, index = c("county_fips", "year"), 
               se = TRUE, inference = "parametric", 
...
You should use the EM method - https://yiqingxu.org/packages/gsynth/articles/tutorial.html#em-method
