...
df <- readRDS(here("data/SHELDUS/SHELDUS_Deryugina.rds"))
...
I have created this different dataset: 
...
```{r eval=FALSE}
  ...
  gov_t_SH_es10 <- aggte(gov_t_SH, type="dynamic", min_e = -10, max_e = 10, balance_e = 10)
...
```{r eval=FALSE}
  ...
  emp_tot_adult_SH_es10 <- aggte(emp_tot_adult_SH, type="dynamic", min_e = -10, max_e = 10, balance_e = 10)
