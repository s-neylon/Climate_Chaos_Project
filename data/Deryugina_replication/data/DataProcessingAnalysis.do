...
local run_analysis			= 1				// This loop runs the main analysis in the paper; set = 1 to run
...
* Restricting sample of hurricanes to first hurricane hit between 1979 and 2002
gen temp=year if hurricane==1 & year>=1979 & year<=2002	
...
gen temp=hurricane if year>=1979 & year<=2002	
...
gen time_lin=year-1969

drop F* L* hurr_f1_2 wind_speed cat*_f1_2 

keep if year<=2012 & year>=1969
